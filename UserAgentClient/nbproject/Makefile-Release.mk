...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/useragentclient: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/useragentclient ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/user_agent.o: user_agent.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/user_agent.o user_agent.cpp
